...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arrExtends = __webpack_require__(5);

	var _arrExtends2 = _interopRequireDefault(_arrExtends);

	var _jq = __webpack_require__(6);
	...
	var num = [1, 2, 3, 4, 5];
	var arr = [2, 3, 3, 5, 8, 4, 8];

	(0, _jq2.default)('body').append('\n    <h3>' + ('[ ' + arr.join(', ') + ' ]') + '去重后为：' + _arrExtends2.default.unique(arr) + '</h3>\n    <h3>' + num.join(' + ') + ' = ' + sum.apply(undefined, num) + '</h3>\n    <img src="./src/img/google.png">\n    <h1> test 15  </h1>\n    ');
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (a, b) {
	  ...
	  var c = [],
	    ...
	    return this.length;
	  }, n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(8) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return n;
